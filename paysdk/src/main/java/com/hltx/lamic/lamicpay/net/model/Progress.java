 ...
 */
package com.hltx.lamic.lamicpay.net.model;
...
import com.hltx.lamic.lamicpay.net.utils.IOUtils;
...
public class Progress implements Serializable {
    ...
    public static Progress changeProgress(final Progress progress, long writeSize, long totalSize, final Action action) {
        ...
        boolean isNotify = (currentTime - progress.lastRefreshTime) >= OkNet.REFRESH_TIME;
