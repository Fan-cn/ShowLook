 ...
 */
package com.hltx.lamic.lamicpay.net.request.base;

import android.text.TextUtils;


import com.hltx.lamic.lamicpay.net.OkNet;
import com.hltx.lamic.lamicpay.net.adapter.AdapterParam;
import com.hltx.lamic.lamicpay.net.adapter.CacheCall;
import com.hltx.lamic.lamicpay.net.adapter.Call;
import com.hltx.lamic.lamicpay.net.adapter.CallAdapter;
import com.hltx.lamic.lamicpay.net.cache.policy.CachePolicy;
import com.hltx.lamic.lamicpay.net.callback.Callback;
import com.hltx.lamic.lamicpay.net.convert.Converter;
import com.hltx.lamic.lamicpay.net.model.HttpHeaders;
import com.hltx.lamic.lamicpay.net.model.HttpMethod;
...
public abstract class Request<T, R extends Request> implements Serializable {
    ...
    public okhttp3.Call getRawCall() {
        ...
        if (client == null) client = OkNet.getInstance().getOkHttpClient();
